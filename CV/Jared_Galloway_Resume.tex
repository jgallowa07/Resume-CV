...
\section{Experience}
    \resumeSubHeadingListStart
        ...
        \resumeSubheading
            {Bioinformatician II}
            {Seattle, WA}
            {Fred Hutchinson CRC -- Matsen Group}
            {Jan 2021 - Current}
            \resumeItemListStart
                ...
                \resumeItem{Scientific Software Development}
                    {}
        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                ...
                \resumeItem{Bioinformatics}
                    {Explored and developed a Nextflow pipeline using best practices for NGS reference alignment.
                    Using this pipeline I've managed the bioinformatics for a variety of separate PhIP-Seq projects --
                    A complex wet-lab technique for exploring the humoral protein interactions of interest using NGS and Oligonucleotide Synthesis.
                    This work produced the data for all results in various publications.}

                \resumeItem{Scientific Software Development}
                    {Developed a python package for handling enrichment data from PhIP-Seq sample alignments.
                    Managed version control, documentation, API, and more as needed by various projects.}

                \resumeItem{Analysis}
                    {Using the alignment and analysis tools described above I was tasked with data analysis giving results for various projects.
                    Additionally, my analysis informed best practices for the wet lab protocol.}

                \resumeItem{Team Organization}
                	{Set up and let team meetings to brainstorm, and set short term goals for all team members involved with various PhIP-Seq projects.}
